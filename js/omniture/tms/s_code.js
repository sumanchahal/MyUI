var tmsomni = ( function() {
  ...
  s.s_code_version =  s.version+'_lexus_2014_04_08_10_38';

  // account selection
  var s_account = (document.domain.match(/^(www|auth\d*?|secure|touch|ssl|drivers|m)\./i)?"tmslexusnew,tmslexusdealernational":"devlexusstaging");
...
function s_doPlugins( s ) {
  ...
  // XD props
  var lastID = s.c_r("tmsvisitor");
  var lastVisit = s.c_r("tmsvisit");
  ...
  s.c_w("tmsvisitor", s.visitorID);
  s.c_w("tmsvisit", s.prop68);
  s.c_w("s_vi", s.visitorID);
  //capture tab number
  if (s._visit){
  ...
  s.campaign = s.getQueryParam( 'cid,siteid,srchid,pdsrch', '', loc );
  s.prop25 = s.campaign;
  s.eVar26 = s.crossVisitParticipation( s.campaign, 's_evar26', '30', '5', '>' );

  s.eVar30 = s.getQueryParam( 's_ocid', '', loc );
  s.prop30 = s.eVar30;
  // internal campaigns
  s.eVar21 = s.getQueryParam( 'intcta', '', loc );
  s.prop44 = s.eVar21;
  ...
  s.prop69 = s.visitorID || s.c_r( "s_vi" );
  if(!s.eVar69&&s.prop69) s.eVar1='D=c69';
...
s.linkTrackVars="prop1,prop2,prop3,prop4,prop5,prop6,prop7,prop8,prop9,prop10,prop11,prop15,prop16,prop17,prop18,prop20,prop21,prop27,prop29,prop30,prop34,prop35,prop38,prop39,prop43,prop47,prop48,prop58,prop63,prop64,prop65,prop69,eVar3,eVar10,eVar11,eVar12,eVar21,eVar44,eVar45,eVar59,events";
s.linkTrackEvents="event5,event9,event70";
...
s._xdBypass = window.self !== window.top;
...
/*!********************************************************************
* vehicleData Plugin v 1.1
*********************************************************************/
s.vehicleData=function(a){
    function d(a){var b=String(a).toString().toLowerCase();return b=b.replace(/(\s|\-)/g,"")}
    function e(a,b){var f,e="",g=d(a);return b=b||"all",g&&(f=c[g],f&&f[b]&&(e=f[b])),e||"Unknown: "+a}
    function f(a){return e(a,"name")}function g(a){return e(a,"type")}function h(a,b){var e=d(a);c[e]={name:a,type:b}}
    function i(a,b){if(a&&b&&b.length)for(var c=0,d=b.length;d>c;c++)h(b[c],a)}var c={};
    return{getName:f,getType:g,addData:h,addModelsByType:i}
}(s);

/*!********************************************************************
* Performance Latency Plugin v 1.1
*********************************************************************/
s.getPerformanceLatency=function(a){function n(b,c,d){var j,k,l,e=this,f=(a.performance||{}).timing,g="",h=(new Date).getTime(),i="now",d=d||0;return f?(d=Math.min(d,20),d=Math.max(d,0),c=o(c)||o("ns"),b=o(b),b&&e?(k=c==i?h:f[c],j=b==i?h:f[b],0==j||0==k?g:(l=(j-k)/1e3,isNaN(d)||(l=l.toFixed(d)),l)):g):""}function o(a){var c,b=m;for(c in b)if(c==a||b[c]==a)return b[c];return""}var b="Start",c="End",d="Event",e="dom",f="load",g="un"+f,i="redirect",j=e+"ainLookup",k="connect",l="response",m={ns:"navigation"+b,us:g+d+b,ue:g+d+c,rds:i+b,rde:i+c,fs:"fetch"+b,dls:j+b,dle:j+c,cs:k+b,ce:k+c,scs:"secureConnection"+b,qs:"request"+b,rs:l+b,re:l+c,dl:e+"Loading",di:e+"Interactive",dcs:e+a+d+b,dce:e+a+d+c,dc:e+"Complete",ls:f+d+b,le:f+d+c,Now:"now"};return n}(window);

/*!********************************************************************
 * Plugin Utility: fixReferrer v1.0
*********************************************************************/
s.fixReferrer=function(a){
  function f(a,b){d[a]=b}function g(a,b,c){e.push({p:a,r:b,c:c})}function h(a){for(var f,g,h=0,i=e.length;i>h;h++)if(g=e[h],c.hasOwnProperty(g.p)||(c[g.p]=b.getQueryParam(g.p,"",a)),f=c[g.p],f.match(g.r))return d[g.c]+f;return""}function i(){c=[],d={},e=[]}var b=a,c=[],d={},e=[];return{setCategory:f,addRule:g,fix:h,reset:i}
}(s);
...
/*!********************************************************************
 * Plugin Utility: getOrientation v1.0
*********************************************************************/
s.getOrientation=function(){switch(window.orientation){case 0:case 180:return"Portrait";case 90:case-90:return"Landscape";default:return""}};

/*!********************************************************************
 * Plugin Utility: union v1.0
*********************************************************************/
s.union=function(a){var d,f,h,b=this,e=Array.prototype.slice.call(arguments,1),g=Object.prototype.hasOwnProperty;a=a||[],targetType=b.getObjectType(a);for(var j=0,k=e.length;k>j;j++){f=e[j],d=b.getObjectType(f),targetType!=d&&(a="array"==d?[]:{});for(var l in f)g.call(f,l)&&(prop=f[l],null!=prop&&(h=typeof prop,a[l]="array"==h||"object"==h?b.union(a[l],prop):prop))}return a},

/*!********************************************************************
 * Plugin Utility: getObjectType v1.0
*********************************************************************/
s.getObjectType=function(a){var c={"[object Boolean]":"boolean","[object Number]":"number","[object String]":"string","[object Function]":"function","[object Array]":"array","[object Date]":"date","[object RegExp]":"regexp","[object Object]":"object","[object Error]":"error","[object Null]":"null","[object Undefined]":"undefined"},d=Object.prototype.toString.call(a);return"object"==typeof a||"function"==typeof a?c[d]||"object":typeof a};

/*!********************************************************************
 * Plugin Utility: managePageNames v1.1 - put below union
*********************************************************************/
s.managePageName=function(a){"use strict";
  function g(a){c=!0,f="function"==typeof b.union?b.union(e,a):e}
  function h(){c||g(e);var a=i(b[f.pageKey]);return b.linkType?b[f.linkProp]=j(a)||b.pageName:b.pageName&&k(a,b.pageName),b.pageName}
  function i(a){return"string"==typeof a&&a.length>0?a.toLocaleLowerCase():"basepage"}
  function j(a){return a=i(a),d[a]||""}
  function k(a,b){a=i(a),d[a]=b}var b=a,c=!1,d={},e={pageKey:"page_key",linkProp:"pageName"},f={};
  return{setConfig:g,update:h,set:k,get:j}
}(s);
s.managePageName.setConfig({linkProp:"prop15"});
...
+"var s=this,v='',q,i;j=h==1?'#':'?';i=u.indexOf(j);if(k&&i>-1){q=u.sub"
...
s.loadModule("Integrate")
    ...
    // additional plugins
    /*********************************************************************
* Lexus 2014 Vehicle Data
*********************************************************************/
s.vehicleData.addModelsByType("Sedan", ["LS","GS", "IS", "ES"]);
s.vehicleData.addModelsByType("Convertible", ["ISC","SC"]);
s.vehicleData.addModelsByType("SUV", ["GX","LX", "RX"]);
s.vehicleData.addModelsByType("Hybrid", ["GSh","RXh", "HSh","LSh","CTh", "ESh"]);
s.vehicleData.addModelsByType("F Performance", ["ISF","IS F Sport", "GS F Sport", "LS F Sport", "ISC F Sport", "CT F Sport", "RX F Sport", "LFA", "F Performance"]);
s.vehicleData.addModelsByType("Future Concept", ["LF-LC", "LF-CC", "NEL", "LF-NX", "RC", "RC F", "Concept Coupe"]);
/*!********************************************************************
* Pad Integer v 1.0
*********************************************************************/
...
*********************************************************************/
s.guidGenerator = function(pattern, base) {
...
var XDLocal = (function(targetURL, bypass) {
  ...
  XDLocal.prototype.sendXDmessage = function(instXDCommand) {
    var msg, instXDCommandMessage, origin;
    if (!instXDCommand) {
      return;
    }
    ...
    try {
      ...
      setTimeout(this.createContextCallback(this, this.messageTimeout, [instXDCommandMessage]), instXDCommandMessage.timeout);
    } catch (e) {
      this.embedFail();
    }
  };
  ...
  XDLocal.prototype.messageTimeout = function(instXDCommandMessage) {
    var callback = this.getCallback(instXDCommandMessage.callbackID),instXDCommand;
    if(callback){
      instXDCommand = this.createCommand(instXDCommandMessage, callback);
      this.returnXDFailed(instXDCommand);
    }
...
var AnalyticsQueue = (function() {
  ...
  AnalyticsQueue.prototype.add = function(obj) {
    if (obj) {
          ...
          try {
            switch (tag.method) {
              ...
              case "tl":
                ...
                break;
              case "open":
                s_code.Media.open(tag.mediaName,  parseFloat(tag.duration), tag.playerName);
                 break;
              case "play":
              s_code.Media.play(tag.mediaName, parseFloat(tag.offest));
              break;
              case "stop":
               s_code.Media.stop(tag.mediaName, parseFloat(tag.offest));
              break;
              case "close":
      ...
      if (!this.data){
        XDLocal.sendCommand("refreshVisit", [], callback);
    } else {
        callback({data:this.data});
        XDLocal.sendCommand("refreshVisit", [], function(){});
    }
