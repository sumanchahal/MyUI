...
(function ($) {
    ...
    $.fn.SumoSelect = function (options) {
        ...
        var settings = $.extend({
            ...
            csvDispCount: 3,              // display no. of items in
											// multiselect. 0 to display all.
            captionFormat:'{0} Selected', // format of caption text. you can
											// set your locale.
            floatWidth: 400,              // Screen width of device at which
											// the list is rendered in floating
											// popup fashion.
            ...
            outputAsCSV: false,           // true to POST data as csv ( false
											// for Html control array ie.
											// deafault select )
            csvSepChar: ',',              // seperation char in csv mode
            okCancelInMulti: false,       // display ok cancel buttons in
											// desktop mode multiselect also.
        ...
        var ret = this.each(function () {
            ...
            if (this.sumo || !$(this).is('select')) return; // already
															// initialized
            ...
            this.sumo = {
                ...
                createElems: function () {
                    ...
                    // if (!$('.BackdropSelect').length) $('body').append('<div
					// class="BackdropSelect">');
                ...
                showOpts: function () {
                    var O = this;
                    if (O.E.attr('disabled')) return; // if select is disabled
														// then retrun
                    O.is_opened = true;
                    // O.backdrop.show();
                ...
                onOptClick: function (li) {
                    ...
                    li.click(function () {
                        ...
                        if (O.is_multi) {
                        	...
                        	if(!li.hasClass('selected') && settings.maxLimit && li.parent().find('li.selected') && li.parent().find('li.selected').length >= settings.maxLimit){
                        		return ;
                        	}
                            ...
                            li.parent().find('li.selected').removeClass('selected'); // if
																						// not
																						// multiselect
																						// then
																						// remove
																						...
																						// list
                            li.toggleClass('selected');
                            O.E.val(li.attr('data-val'));   // set the value of
															// select element
                        }
                        ...
                        if (!O.is_multi) O.hideOpts(); // if its not a
														// multiselect then hide
														// on single select.
                    });
                },
                ...
                // ## disables the whole select elements these are getter and
				// setters.
                get disabled() {
